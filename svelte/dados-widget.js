...
const dt = 2, Ur = 4, Ve = 8, Tn = 16, Vt = 32, In = 64, lo = 128, Et = 256, we = 512, rt = 1024, St = 2048, Bt = 4096, At = 8192, ln = 16384, Hr = 32768, Vr = 65536, ci = 1 << 17, Ga = 1 << 18, Br = 1 << 19, fo = 1 << 20, fr = 1 << 21, Xr = 1 << 22, tn = 1 << 23, nn = Symbol("$state"), Ka = Symbol("legacy props"), Yr = new class extends Error {
...
function Gr(t) {
  ...
  return H === null || e !== null && (e.f & Et) !== 0 ? n |= Et : H.f |= Br, {
    ctx: Q,
    deps: null,
    effects: null,
    equals: co,
...
function yo(t) {
  ...
  if (t.equals(n) || (t.v = n, t.wv = $o()), !cn)
    if (En !== null)
      ...
      var e = (Gt || (t.f & Et) !== 0) && t.deps !== null ? Bt : rt;
      lt(t, e);
    }
}
function ds(t, n, e) {
...
class Vn {
  ...
  #v(n) {
    ...
    for (var e = n.first; e !== null; ) {
      var r = e.f, i = (r & (Vt | In)) !== 0, o = i && (r & rt) !== 0, a = o || (r & At) !== 0 || this.skipped_effects.has(e);
      if (!a && e.fn !== null) {
        if (i)
          e.f ^= rt;
        else if ((r & Ur) !== 0)
...
function F(t, n, e = !1) {
  ...
  (!Tt || (V.f & ci) !== 0) && Rn() && (V.f & (dt | Tn | Xr | ci)) !== 0 && !Ut?.includes(t) && as();
  let r = e ? gn(n) : n;
  return be(t, r);
}
function be(t, n) {
  if (!t.equals(n)) {
    ...
    r.capture(t, e), (t.f & dt) !== 0 && ((t.f & St) !== 0 && Zr(
      /** @type {Derived} */
      t
    ), lt(t, (t.f & Et) === 0 ? rt : Bt)), t.wv = $o(), Eo(t, St), Rn() && H !== null && (H.f & rt) !== 0 && (H.f & (Vt | In)) === 0 && (mt === null ? Os([t]) : mt.push(t));
  }
  return n;
}
function Je(t) {
...
function gn(t) {
  ...
  if (n !== Ba && n !== Xa)
    return t;
  var e = /* @__PURE__ */ new Map(), r = qr(t), i = /* @__PURE__ */ Yt(0), o = en, a = (s) => {
    if (en === o)
      return s();
    var l = V, f = en;
    Ct(null), gi(o);
  ...
  return r && e.set("length", /* @__PURE__ */ Yt(
    /** @type {any[]} */
    t.length
  )), new Proxy(
    /** @type {any} */
    t,
    {
      ...
      get(s, l, f) {
        ...
        if (u === void 0 && (!c || pe(s, l)?.writable) && (u = a(() => {
          var p = gn(c ? s[l] : et), d = /* @__PURE__ */ Yt(p);
          return d;
        }), e.set(l, u)), u !== void 0) {
          var h = I(u);
      ...
      has(s, l) {
        ...
        if (f !== void 0 || H !== null && (!u || pe(s, l)?.writable)) {
          f === void 0 && (f = a(() => {
            var h = u ? gn(s[l]) : et, p = /* @__PURE__ */ Yt(h);
            return p;
          }), e.set(l, f));
          var c = I(f);
          if (c === et)
      ...
      set(s, l, f, u) {
        ...
        if (r && l === "length")
          ...
          c.v; p += 1) {
            var d = e.get(p + "");
            d !== void 0 ? F(d, et) : p in s && (d = a(() => /* @__PURE__ */ Yt(et)), e.set(p + "", d));
          }
        if (c === void 0)
          (!h || pe(s, l)?.writable) && (c = a(() => /* @__PURE__ */ Yt(void 0)), F(c, gn(f)), e.set(l, c));
        else {
          h = c.v !== et;
          var w = a(() => gn(f));
          F(c, w);
...
function bo(t) {
  H === null && V === null && ns(), V !== null && (V.f & Et) !== 0 && H === null && ts(), cn && ja();
}
function Ms(t, n) {
  var e = n.last;
  e === null ? n.last = n.first = t : (e.next = t, t.prev = e, n.last = t);
}
function Xt(t, n, e, r = !0) {
  var i = H;
...
function Is() {
  ...
  Ye(() => {
    for (var n of t.l.$) {
      n.deps();
      var e = n.effect;
      (e.f & rt) !== 0 && lt(e, Bt), ne(e) && rn(e), n.ran = !1;
    }
  });
}
function Rs(t) {
...
function Qr(t, n, e) {
  if ((t.f & At) === 0) {
    ...
    for (var r = t.first; r !== null; ) {
      var i = r.next, o = (r.f & Vr) !== 0 || (r.f & Vt) !== 0;
      Qr(r, n, o ? e : !1), r = i;
    }
  }
}
...
function Po(t, n) {
  if ((t.f & At) !== 0) {
    ...
    for (var e = t.first; e !== null; ) {
      var r = e.next, i = (e.f & Vr) !== 0 || (e.f & Vt) !== 0;
      Po(e, i ? n : !1), e = r;
    }
...
function ne(t) {
  ...
  if ((n & Bt) !== 0) {
    ...
    if (e !== null) {
      var i, o, a = (n & we) !== 0, s = r && H !== null && !Gt, l = e.length;
      if ((a || s) && (H === null || (H.f & ln) === 0)) {
        var f = (
          /** @type {Derived} */
          t
        ), u = f.parent;
  ...
  if (r !== null && !Ut?.includes(t))
    for (var i = 0; i < r.length; i++) {
      ...
      (o.f & dt) !== 0 ? Oo(
        ...
        n,
        !1
      ) : n === o && (e ? lt(o, St) : (o.f & rt) !== 0 && lt(o, Bt), Sn(
        /** @type {Effect} */
        o
      ));
    }
...
function zo(t) {
  var n = st, e = pt, r = mt, i = V, o = Gt, a = Ut, s = Q, l = Tt, f = en, u = t.f;
  st = /** @type {null | Value[]} */
  null, pt = 0, mt = null, Gt = (u & Et) !== 0 && (Tt || !wn || V === null), V = (u & (Vt | In)) === 0 ? t : null, Ut = null, xe(t.ctx), Tt = !1, en = ++Xn, t.ac !== null && (Xe(() => {
    t.ac.abort(Yr);
  }), t.ac = null);
  try {
    t.f |= fr;
    ...
    if (Rn() && mt !== null && !Tt && p !== null && (t.f & (dt | Bt | St)) === 0)
    ...
    t.f ^= fr, st = n, pt = e, mt = r, V = i, Gt = o, Ut = a, xe(s), Tt = l, en = f;
  }
}
function zs(t, n) {
  let e = n.reactions;
  ...
  (st === null || !st.includes(n)) && (lt(n, Bt), (n.f & (Et | we)) === 0 && (n.f ^= we), mo(
    /** @type {Derived} **/
    n
  ), Ne(
    /** @type {Derived} **/
    ...
    if (!(u && y === 0)) {
      ...
      if (So()) {
        ...
        for (const [O, k] of s.items)
          T.has(O) || R.skipped_effects.add(k.e);
        R.add_callback(w);
      } else
        w();
      I(h);
  ...
  for (b = 0; b < f; b += 1) {
    if (x = n[b], m = s(x, b), E = u.get(m), E === void 0) {
      ...
      if (T !== void 0) {
        ...
        var R = d ? d.next : h;
        kt(e, d, T), kt(e, T, R), Qe(T, R, i), d = T;
      } else {
        var z = h ? (
          /** @type {TemplateNode} */
          h.e.nodes_start
...
function Uo(t, n, e, r, i, o, a, s, l, f, u) {
  var c = (l & $a) !== 0, h = (l & za) === 0, p = c ? h ? /* @__PURE__ */ qt(i, !1, !1) : Bn(i) : i, d = (l & Oa) === 0 ? a : Bn(a), w = {
    i: d,
    v: p,
    k: o,
    a: null,
  ...
  return (
    ...
    (function(m, E) {
      if (arguments.length > 0) {
        const b = E ? I(y) : i && o ? gn(m) : m;
        return F(y, b), w = !0, a !== void 0 && (a = b), m;
      }
      return cn && w || (x.f & ln) !== 0 ? y.v : I(y);
    })
  );
}
class an {
...
function of(t, n) {
  ...
  for (t = t + "", n = n + ""; (r = yr.exec(t)) && (i = er.exec(n)); )
    (o = i.index) > e && (o = n.slice(e, o), s[a] ? s[a] += o : s[++a] = o), (r = r[0]) === (i = i[0]) ? s[a] ? s[a] += i : s[++a] = i : (s[++a] = null, l.push({ i: a, x: Wt(r, i) })), e = er.lastIndex;
...
function sa(t, n, e, r) {
  ...
  function o(f, u, c, h, p, d) {
    if (f !== c || u !== h) {
      ...
      d.push({ i: w - 4, x: Wt(f, c) }, { i: w - 2, x: Wt(u, h) });
    } else (c || h) && p.push("translate(" + c + n + h + e);
  }
  function a(f, u, c, h) {
    f !== u ? (f - u > 180 ? u += 360 : u - f > 180 && (f += 360), h.push({ i: c.push(i(c) + "rotate(", null, r) - 2, x: Wt(f, u) })) : u && c.push(i(c) + "rotate(" + u + r);
  }
  function s(f, u, c, h) {
    f !== u ? h.push({ i: c.push(i(c) + "skewX(", null, r) - 2, x: Wt(f, u) }) : u && c.push(i(c) + "skewX(" + u + r);
  }
...
const pf = (function t(n, e, r) {
  function i(o, a) {
    ...
    if (w < ff)
      ...
      var m = Math.sqrt(w), E = (h * h - f * f + r * w) / (2 * f * e * m), b = (h * h - f * f - r * w) / (2 * h * e * m), T = Math.log(Math.sqrt(E * E + 1) - E), R = Math.log(Math.sqrt(b * b + 1) - b);
      x = (R - T) / n, y = function(z) {
...
function ha(t, n) {
  var e;
  return (typeof n == "number" ? Wt : n instanceof Gn ? Ci : (e = Gn(n)) ? (n = e, Ci) : of)(t, n);
}
function Mf(t) {
  return function() {
    this.removeAttribute(t);
...
function bc(t) {
  var n, e;
  t instanceof Ht ? (n = t._id, t = t._name) : (n = va(), (e = Ec).time = ii(), t = t == null ? null : t + "");
...
var B = 1e-6, U = Math.PI, ct = U / 2, Fi = U / 4, gt = U * 2, vt = 180 / U, nt = U / 180, W = Math.abs, da = Math.atan, Zn = Math.atan2, Z = Math.cos, Mc = Math.exp, Ac = Math.log, J = Math.sin, Nc = Math.sign || function(t) {
...
function kr(t, n) {
  return W(t) > U && (t -= Math.round(t / gt) * gt), [t, n];
}
kr.invert = kr;
function _a(t, n, e) {
...
function Bi(t) {
  return function(n, e) {
    return n += t, W(n) > U && (n -= Math.round(n / gt) * gt), [n, e];
  };
}
function Xi(t) {
  var n = Bi(t);
...
function ir(t) {
  return W(t[0]) <= U ? t[0] : Nc(t[0]) * ((W(t[0]) + U) % gt - U);
}
function Pc(t, n) {
  ...
  for (var f = 0, u = t.length; f < u; ++f)
    if (h = (c = t[f]).length)
      for (var c, h, p = c[h - 1], d = ir(p), w = p[1] / 2 + Fi, y = J(w), x = Z(w), m = 0; m < h; ++m, d = b, y = R, x = z, p = E) {
        var E = c[m], b = ir(E), T = E[1] / 2 + Fi, R = J(T), z = Z(T), O = b - d, k = O >= 0 ? 1 : -1, A = k * O, N = A > U, D = y * R;
...
function ya(t, n, e, r) {
  return function(i) {
    ...
    function E() {
      ...
      var b = s.clean(), T = a.result(), R, z = T.length, O, k, A;
      if (c.pop(), f.push(c), c = null, !!z) {
        if (b & 1) {
          if (k = T[0], (O = k.length - 1) > 0) {
            for (l || (i.polygonStart(), l = !0), i.lineStart(), R = 0; R < O; ++R) i.point((A = k[R])[0], A[1]);
            i.lineEnd();
          }
          return;
        }
...
function Oc(t) {
  ...
  return {
    ...
    point: function(o, a) {
      ...
      W(l - U) < B ? (t.point(n, e = (e + a) / 2 > 0 ? ct : -ct), t.point(r, e), t.lineEnd(), t.lineStart(), t.point(s, e), t.point(o, e), i = 0) : r !== s && l >= U && (W(n - r) < B && (n -= r * B), W(o - s) < B && (o -= s * B), e = zc(n, e, o, a), t.point(r, e), t.lineEnd(), t.lineStart(), t.point(s, e), i = 0), t.point(n = o, e = a), r = s;
    },
    lineEnd: function() {
      t.lineEnd(), n = e = NaN;
    },
...
function Dc(t, n, e, r) {
  var i;
  if (t == null)
    i = e * ct, r.point(-U, i), r.point(0, i), r.point(U, i), r.point(U, 0), r.point(U, -i), r.point(0, -i), r.point(-U, -i), r.point(-U, 0), r.point(-U, i);
  else if (W(t[0] - n[0]) > B) {
    var o = t[0] < n[0] ? U : -U;
...
function Lc(t) {
  ...
  function s(u) {
    ...
    return {
      ...
      point: function(y, x) {
        var m = [y, x], E, b = a(y, x), T = r ? b ? 0 : f(y, x) : b ? f(y + (y < 0 ? U : -U), x) : 0;
        if (!c && (d = p = b) && u.lineStart(), b !== p && (E = l(c, m), (!E || ye(c, E) || ye(m, E)) && (m[2] = 1)), b !== p)
          ...
          var R;
          !(T & h) && (R = l(m, c, !0)) && (w = 0, r ? (u.lineStart(), u.point(R[0][0], R[0][1]), u.point(R[1][0], R[1][1]), u.lineEnd()) : (u.point(R[1][0], R[1][1]), u.lineEnd(), u.lineStart(), u.point(R[0][0], R[0][1], 3)));
        }
  ...
  function l(u, c, h) {
    ...
    if (!E) return !h && u;
    var b = n * x / E, T = -n * m / E, R = ze(w, y), z = le(w, b), O = le(y, T);
    rr(z, O);
    var k = R, A = ue(z, k), N = ue(k, k), D = A * A - N * (ue(z, z) - 1);
    if (!(D < 0)) {
      var C = hn(D), v = le(k, (-A - C) / N);
      if (rr(v, z), v = Mr(v), !h) return v;
      var _ = u[0], g = c[0], S = u[1], M = c[1], P;
      g < _ && (P = _, _ = g, g = P);
      var $ = g - _, L = W($ - U) < B, q = L || $ < B;
      if (!L && M < S && (P = S, S = M, M = P), q ? L ? S + M > 0 ^ v[1] < (W(v[0] - _) < B ? S : M) : S <= v[1] && v[1] <= M : $ > U ^ (_ <= v[0] && v[0] <= g)) {
        var G = le(k, (-A + C) / N);
...
function Fc(t, n, e, r) {
  ...
  return function(f) {
    var u = f, c = ga(), h, p, d, w, y, x, m, E, b, T, R, z = {
      point: O,
      lineStart: D,
      lineEnd: C,
      polygonStart: A,
    ...
    function k() {
      for (var _ = 0, g = 0, S = p.length; g < S; ++g)
        for (var M = p[g], P = 1, $ = M.length, L = M[0], q, G, X = L[0], j = L[1]; P < $; ++P)
          q = X, G = j, L = M[P], X = L[0], j = L[1], G <= r ? j > r && (X - q) * (r - G) > (j - G) * (t - q) && ++_ : j <= r && (X - q) * (r - G) < (j - G) * (t - q) && --_;
      return _;
    }
    function A() {
      u = c, h = [], p = [], R = !0;
    ...
    function v(_, g) {
      ...
      if (p && d.push([_, g]), T)
        ...
        var M = [m = Math.max(ce, Math.min(Dn, m)), E = Math.max(ce, Math.min(Dn, E))], P = [_ = Math.max(ce, Math.min(Dn, _)), g = Math.max(ce, Math.min(Dn, g))];
        qc(M, P, t, n, e, r) ? (b || (u.lineStart(), u.point(M[0], M[1])), u.point(P[0], P[1]), S || u.lineEnd(), R = !1) : S && (u.lineStart(), u.point(_, g), R = !1);
      }
      m = _, E = g, b = S;
    }
    return z;
...
function ih(t, n) {
  function e(r, i, o, a, s, l, f, u, c, h, p, d, w, y) {
    ...
    if (E > 4 * n && w--) {
      var b = a + h, T = s + p, R = l + d, z = hn(b * b + T * T + R * R), O = Jn(R /= z), k = W(W(R) - 1) < B || W(o - c) < B ? (o + c) / 2 : Zn(T, b), A = t(k, O), N = A[0], D = A[1], C = N - r, v = D - i, _ = m * C - x * v;
      (_ * _ / E > n || W((x * C + m * v) / E - 0.5) > 0.3 || a * h + s * p + l * d < eh) && (e(r, i, o, a, s, l, N, D, k, b /= z, T /= z, R, w, y), y.point(N, D), e(N, D, k, b, T, R, f, u, c, h, p, d, w, y));
    }
  }
  return function(r) {
...
function lh(t) {
  var n, e = 150, r = 480, i = 250, o = 0, a = 0, s = 0, l = 0, f = 0, u, c = 0, h = 1, p = 1, d = null, w = Ki, y = null, x, m, E, b = Tr, T = 0.5, R, z, O, k, A;
  function N(_) {
  ...
  N.stream = function(_) {
    return k && A === _ ? k : k = oh(ah(u)(w(R(b(A = _)))));
    ...
    return arguments.length ? (R = ro(z, T = _ * _), v()) : hn(T);
  ...
  function C() {
    ...
    return u = _a(s, l, f), z = Nr(n, g), O = Nr(u, z), R = ro(z, T), v();
  }
  function v() {
    return k = A = null, N;
  }
...
function ch(t) {
  ...
  function u() {
    var c = U * r(), h = n(Ic(n.rotate()).invert([0, 0]));
...
function mh() {
  ...
  x.transform = function(v, _, g, S) {
    ...
    M.property("__zoom", oo), v !== M ? T(v, _, g, S) : M.interrupt().each(function() {
      R(this, arguments).event(S).start().zoom(null, typeof _ == "function" ? _.apply(this, arguments) : _).end();
    });
  }, x.scaleBy = function(v, _, g, S) {
    x.scaleTo(v, function() {
      var M = this.__zoom.k, P = typeof _ == "function" ? _.apply(this, arguments) : _;
      return M * P;
    }, g, S);
  }, x.scaleTo = function(v, _, g, S) {
    x.transform(v, function() {
      var M = n.apply(this, arguments), P = this.__zoom, $ = g == null ? b(M) : typeof g == "function" ? g.apply(this, arguments) : g, L = P.invert($), q = typeof _ == "function" ? _.apply(this, arguments) : _;
      return e(E(m(P, q), $, L), M, a);
    }, g, S);
    ...
    x.transform(v, function() {
      var P = n.apply(this, arguments), $ = this.__zoom, L = S == null ? b(P) : typeof S == "function" ? S.apply(this, arguments) : S;
  ...
  function m(v, _) {
    return _ = Math.max(o[0], Math.min(o[1], _)), _ === v.k ? v : new Ft(_, v.x, v.y);
  }
  function E(v, _, g) {
    var S = _[0] - g[0] * v.k, M = _[1] - g[1] * v.k;
    return S === v.x && M === v.y ? v : new Ft(v.k, S, M);
  }
  function b(v) {
  ...
  function T(v, _, g, S) {
    v.on("start.zoom", function() {
      ...
      var M = this, P = arguments, $ = R(M, P).event(S), L = n.apply(M, P), q = g == null ? b(L) : typeof g == "function" ? g.apply(M, P) : g, G = Math.max(L[1][0] - L[0][0], L[1][1] - L[0][1]), X = M.__zoom, j = typeof _ == "function" ? _.apply(M, P) : _, bt = l(X.invert(q).concat(G / X.k), j.invert(q).concat(G / j.k));
      return function(ht) {
        if (ht === 1) ht = j;
        else {
          var Y = bt(ht), ot = G / Y[2];
          ht = new Ft(ot, q[0] - Y[0] * ot, q[1] - Y[1] * ot);
        }
        $.zoom(null, ht);
      };
    });
  ...
  function O(v, ..._) {
    ...
    var g = R(this, _).event(v), S = this.__zoom, M = Math.max(o[0], Math.min(o[1], S.k * Math.pow(2, r.apply(this, arguments)))), P = Jt(v);
    if (g.wheel)
      (g.mouse[0][0] !== P[0] || g.mouse[0][1] !== P[1]) && (g.mouse[1] = S.invert(g.mouse[0] = P)), clearTimeout(g.wheel);
    else {
      if (S.k === M) return;
      g.mouse = [P, S.invert(P)], me(this), g.start();
    }
  ...
  function k(v, ..._) {
    ...
    var g = v.currentTarget, S = R(this, _, !0).event(v), M = ut(v.view).on("mousemove.zoom", q, !0).on("mouseup.zoom", G, !0), P = Jt(v, g), $ = v.clientX, L = v.clientY;
    ql(v.view), sr(v), S.mouse = [P, this.__zoom.invert(P)], me(this), S.start();
    function q(X) {
      if ($n(X), !S.moved) {
  ...
  function A(v, ..._) {
    if (t.apply(this, arguments)) {
      var g = this.__zoom, S = Jt(v.changedTouches ? v.changedTouches[0] : v, this), M = g.invert(S), P = g.k * (v.shiftKey ? 0.5 : 2), $ = e(E(m(g, P), S, M), n.apply(this, _), a);
      $n(v), s > 0 ? ut(this).transition().duration(s).call(T, $, S, v) : ut(this).call(x.transform, $, S, v);
    }
  }
  function N(v, ..._) {
    if (t.apply(this, arguments)) {
      var g = v.touches, S = g.length, M = R(this, _, v.changedTouches.length === S).event(v), P, $, L, q;
      for (sr(v), $ = 0; $ < S; ++$)
        L = g[$], q = Jt(L, this), q = [q, this.__zoom.invert(q), L.identifier], M.touch0 ? !M.touch1 && M.touch0[2] !== q[2] && (M.touch1 = q, M.taps = 0) : (M.touch0 = q, P = !0, M.taps = 1 + !!u);
      u && (u = clearTimeout(u)), P && (M.taps < 2 && (c = q[0], u = setTimeout(function() {
        u = null;
      }, p)), me(this), M.start());
    }
  }
  function D(v, ..._) {
    if (this.__zooming) {
      var g = R(this, _).event(v), S = v.changedTouches, M = S.length, P, $, L, q;
      for ($n(v), P = 0; P < M; ++P)
        $ = S[P], L = Jt($, this), g.touch0 && g.touch0[2] === $.identifier ? g.touch0[0] = L : g.touch1 && g.touch1[2] === $.identifier && (g.touch1[0] = L);
  ...
  function C(v, ..._) {
    if (this.__zooming) {
      var g = R(this, _).event(v), S = v.changedTouches, M = S.length, P, $;
      for (sr(v), h && clearTimeout(h), h = setTimeout(function() {
        h = null;
      }, p), P = 0; P < M; ++P)
        $ = S[P], g.touch0 && g.touch0[2] === $.identifier ? delete g.touch0 : g.touch1 && g.touch1[2] === $.identifier && delete g.touch1;
...
function Eh(t, n) {
  po(n, !1);
  let e = /* @__PURE__ */ qt(), r = [], i = null, o = /* @__PURE__ */ qt(!0), a = /* @__PURE__ */ qt(null), s = /* @__PURE__ */ qt(null), l = null, f = nu(n, "selectedMunicipio", 8, "");
  qo(() => {
    setTimeout(
      async () => {
        try {
...
`), D = N[0].split(";");
          ...
          i = await v.json(), u(), F(o, !1);
        } catch (k) {
          console.error("Erro ao carregar dados:", k), F(a, k.message), F(o, !1);
        }
      },
      100
    );
  ...
  function u() {
    if (!i || !I(e))
      return;
    const k = 800, A = 500;
    ut(I(e)).selectAll("*").remove();
    const N = ut(I(e)).append("svg").attr("width", "100%").attr("height", "100%").attr("viewBox", `0 0 ${k} ${A}`).style("background", "transparent").style("cursor", "grab"), D = mh().scaleExtent([1, 8]).on("zoom", (C) => {
    ...
    try {
      ...
      F(s, N.selectAll("path").data(i.features).enter().append("path").attr("d", v).attr("fill", (g) => {
        ...
        const M = S.properties.NAME_2 || S.properties.name || "Desconhecido", P = r[M];
        let $ = `<strong>${M}</strong>`;
        if (P) {
          const L = P.RAI?.trim().toUpperCase() === "SIM" ? "Sim" : "Não";
          $ += `<br/>RAI: ${L}`;
          const q = P.PORTAL?.trim();
          q && q !== "NAO" && q.startsWith("http") ? $ += `<br/>Portal: <a href="${q}" target="_blank">${q}</a>` : $ += "<br/>Portal: Não", P.DISTRITO && ($ += `<br/>Distrito: ${P.DISTRITO}`);
        } else
      ...
      console.error("Erro ao criar mapa:", C), F(a, C.message);
    }
  }
  function c(k) {
  ...
  function p() {
    l && ut(I(e)).select("svg").transition().duration(300).call(l.scaleBy, 1.5);
  }
  function d() {
    l && ut(I(e)).select("svg").transition().duration(300).call(l.scaleBy, 1 / 1.5);
  }
  function w() {
    l && ut(I(e)).select("svg").transition().duration(300).call(l.transform, fi);
  }
  Ts(() => (Lo(f()), I(s)), () => {
    f() !== void 0 && I(s) && (console.log("selectedMunicipio mudou:", f()), h(f()));
  }), Is(), Ho();
  var y = xh(), x = tt(y);
  {
    var m = (k) => {
      ...
      var A = Hs(), N = hr(A);
      {
        var D = (C) => {
          ...
          vn(() => dn(g, `Erro ao carregar o mapa: ${I(a) ?? ""}`)), yt(C, v);
        };
        mn(
          N,
          (C) => {
  ...
  var b = it(x, 2);
  js(b, (k) => F(e, k), () => I(e));
  var T = it(b, 2), R = tt(T), z = it(R, 2), O = it(z, 2);
  Dt("click", R, p), Dt("click", z, d), Dt("click", O, w), yt(t, y), vo();
}
...
function Ih(t, n) {
  po(n, !1);
  let e = /* @__PURE__ */ qt(""), r = [], i = /* @__PURE__ */ qt(null), o = "", a = /* @__PURE__ */ qt([]), s = /* @__PURE__ */ qt("");
  qo(() => {
    setTimeout(
      async () => {
        try {
...
`), C = D[0].split(";");
  ...
  function f() {
    if (I(e).trim()) {
      const A = c(I(e));
      F(i, r.find((N) => c(N.MUNICIPIO || "") === A)), I(i) ? F(s, I(i).MUNICIPIO) : F(
        s,
        A
  ...
  function d() {
    if (I(i) && F(i, null), I(e).length > 0 && r.length > 0) {
      const A = c(I(e));
      F(a, r.filter((N) => {
        const D = N.MUNICIPIO || "";
  ...
  var w = Th(), y = tt(w), x = it(tt(y), 2), m = tt(x), E = it(m, 2), b = it(x, 2);
  {
    var T = (A) => {
      ...
      Ys(N, 5, () => I(a), Bs, (D, C) => {
        var v = Sh(), _ = tt(v);
        vn(() => dn(_, (I(C), at(() => I(C).MUNICIPIO)))), Dt("click", v, () => l(I(C).MUNICIPIO)), yt(D, v);
      }), yt(A, N);
    };
    mn(b, (A) => {
      I(a), at(() => I(a).length > 0) && A(T);
    });
  }
  var R = it(b, 2);
  {
    var z = (A) => {
      var N = kh(), D = tt(N), C = tt(D), v = it(D, 2), _ = it(tt(v)), g = tt(_), S = tt(g), M = tt(S);
      {
        var P = (Y) => {
          ...
          vn(() => dn(Ze, (I(i), at(() => I(i).RAI_Email)))), yt(Y, ot);
        }, $ = (Y) => {
          var ot = Ah(), pn = it(hr(ot)), Ze = tt(pn);
          vn(() => {
            yi(pn, "href", (I(i), at(() => I(i).Website))), dn(Ze, (I(i), at(() => I(i).Website)));
          }), yt(Y, ot);
        };
        mn(M, (Y) => {
          I(i), at(() => I(i).RAI?.toLowerCase() === "sim") ? Y(P) : Y($, !1);
        });
      }
      var L = it(S), q = tt(L);
      {
        var G = (Y) => {
          var ot = Nh(), pn = tt(ot);
          vn(() => {
            yi(ot, "href", (I(i), at(() => I(i).PORTAL))), dn(pn, (I(i), at(() => I(i).PORTAL)));
          }), yt(Y, ot);
        }, X = (Y) => {
        ...
        mn(q, (Y) => {
          I(i), at(() => I(i).PORTAL && I(i).PORTAL.toLowerCase() !== "nao" && I(i).PORTAL.toLowerCase() !== "não") ? Y(G) : Y(X, !1);
        });
      }
      var j = it(L), bt = tt(j), ht = it(v, 2);
      vn(() => dn(C, (I(i), at(() => I(i).MUNICIPIO)))), Dt("click", bt, () => p(I(i).MUNICIPIO)), Dt("click", ht, () => {
        F(i, null), F(e, ""), F(s, "");
      }), yt(A, N);
    };
    mn(R, (A) => {
  ...
  }), Qs(m, () => I(e), (A) => F(e, A)), Dt("input", m, d), Dt("keydown", m, u), Dt("click", E, f), yt(t, w), vo();
}
class Rh {
  constructor(n) {
...
typeof window < "u" && (window.DadosWidget = Rh);
export {
  Rh as default
};
